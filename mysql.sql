...
("OaRyNwBh2Vp", 115.6, "Subaru", "Impreza", "Blue", "Gamer10")
    ...
    create table leaderBoard(pname varchar(30) primary key , score int default 0 , level int default 1,gameover boolean default false)
    INSERT INTO leaderBoard  
VALUES
("Jaganna" , 400, 5,false),
("Sathvik", 0, 1,false)
    
    create table users(username varchar(30) primary key , password varchar(30) not null , admin_role boolean default false )
    INSERT INTO users   VALUES  ("Sathvik", "gg", True)
